...
class GccTest {
  ...
  runIntegrationTests(QUnit) {
    ...
    QUnit.test('validateRangeValues', (assert) => {
      assert.equal(
        ...
        'Non-empty string value rejected when not present in validation list',
      );
      ...
      assert.equal(
        ...
        'Non-empty string value rejected when checkbox validation',
      );
      ...
      assert.equal(
        ...
        '"" is a valid value for cell J24 (VALUE_IN_LIST 0,1,5,10,15,20,25,Not found,No access,Dropped (first),Collected (final),See group chat,------,See notes,Back to normal,Drop,First collection,Skip,Final,COVID case,Cancelled,Pending)',
  ...
  stubGccRunGroup() {
    // suburbs - town:
    // 'Fri Jan 04 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Jan 11 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Jan 18 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Jan 25 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Feb 01 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Feb 08 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Feb 15 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    // 'Fri Feb 22 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    this.stub('GccRunGroupInstance.getDateHeaders', [], [
      'Wed Jan 02 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
      'Wed Jan 09 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
      'Wed Jan 16 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
      'Wed Jan 23 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
      'Wed Jan 30 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
      'Wed Feb 06 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
      'Wed Feb 13 2030 00:00:00 GMT+1300 (New Zealand Daylight Time)',
    ]);
    ...
    this.stub('GccSheetInstance.getNamedRangeRunGroups', [], [
      {
        ...
        _dateHeaders: [
          ...
          '2030-01-09T11:00:00.000Z',
          '2030-01-16T11:00:00.000Z',
          '2030-01-23T11:00:00.000Z',
          '2030-01-30T11:00:00.000Z',
          '2030-02-06T11:00:00.000Z',
          '2030-02-13T11:00:00.000Z',
        ],
        _dateHeadersFormatted: [
          'Jan 2',
          'Jan 9',
      ...
      },
      {
        ...
        _dateHeaders: [
          '2030-01-04T11:00:00.000Z',
          '2030-01-11T11:00:00.000Z',
          '2030-01-18T11:00:00.000Z',
          '2030-01-25T11:00:00.000Z',
          '2030-02-01T11:00:00.000Z',
          '2030-02-08T11:00:00.000Z',
          '2030-02-15T11:00:00.000Z',
          '2030-02-22T11:00:00.000Z',
        ],
        _dateHeadersFormatted: [
          'Jan 4',
          'Jan 11',
